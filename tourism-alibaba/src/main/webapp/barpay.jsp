...
<%@ page import="com.alipay.api.response.*"%>
	...
	if(request.getParameter("WIDout_trade_no")!=null){
		...
		//付款金额
		String total_amount = new String(request.getParameter("WIDtotal_fee").getBytes("ISO-8859-1"),"UTF-8");
		//必填
		
		//付款条码
		String auth_code = new String(request.getParameter("WIDtotal_auth_code").getBytes("ISO-8859-1"),"UTF-8");
		//必填
        ...
        <form name=alipayment action="" method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDtotal_auth_code" />
						<span>必填
</span>
					</dd>
