...
<head>
    ...
    <style>
        .zfcg{background: #fff; text-align: center;border-bottom: 1px solid #ddd;padding-bottom: 0.7rem;padding-top: 0.2rem;font-size: 0.26rem;}
        .zfcg ul{width: 80%;margin: 0.7rem auto;}
        .zfcg ul li{display: table;width: 100%; text-align: left}
        .zfcg ul li .zfcttabletitle{width: 200px;display: table-cell;color: #999;text-align:right;margin-top:100px}
        .zfcg ul li p{display: table-cell;}
    </style>
</head>
...
<div class="indcont" style="clear:both;height:200px;">
    ...
    <div class="navwarp" style="clear:both">
        <ul class="nav_menu">
    ...
    <section class="zfcg" >
        ...
        <ul>
            <li><span class="zfcttabletitle">订单号码：</span><p>${orderInfo.orderNo}</p></li>
            <li><span class="zfcttabletitle">支付金额：</span><p><span class="redc">￥${orderInfo.tprice}</span></p></li>
            <li><span class="zfcttabletitle">产品名称：</span><p>${orderInfo.orderName}</p></li>
            <li><span class="zfcttabletitle">购买个数：</span><p>${orderInfo.tnum}</p></li>
            <li><span class="zfcttabletitle">总价：</span><p>${orderInfo.orderAmount}</p></li>
            <li><span class="zfcttabletitle">联系人手机号：</span><p>${orderInfo.orderTel}</p></li>

        </ul>

        <div class="cgbutbox">
            <span onclick="window.location='../wd/wddd.html'">确认支付</span>
